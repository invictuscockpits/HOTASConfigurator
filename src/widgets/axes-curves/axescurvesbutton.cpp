...
void AxesCurvesButton::installStyleSheet()
{
    setStyleSheet(QStringLiteral(R"(
        AxesCurvesButton[checked="true"], AxesCurvesButton[pressed="true"] {
            background-color: rgba(5, 170, 61, 40);  /* INVICTUS GREEN overlay */
        }
        ...
        AxesCurvesButton[hover="true"] {
            border: 1px solid;
            border-color: rgb(5, 170, 61);  /* INVICTUS GREEN border */
        }
        ...
        AxesCurvesButton[lastChecked="true"] {
            border: 1px solid;
            border-color: border-color: rgb(5, 255, 150); /* INVICTUS GREEN border */
        }
