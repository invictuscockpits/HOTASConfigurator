...
public:
    ...
    explicit AxesCurvesConfig(AxesConfig* axesConfig, QWidget* parent = nullptr);
    QList<AxesCurvesProfiles*> profileList() const { return m_profiles; }
public slots:
    void handleAxisVisibility(int index, bool visible); // Responds to axis checkbox state
