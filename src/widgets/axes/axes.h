...
public:
    ...
    void setComboBox_AxisSource1Visibility(bool enabled);
    void setText_axisSourceVisibility(bool enabled);
    void setCalibrationMax(int maxValue);
    void setCalibrationMin(int minValue);
    AxesExtended* getAxesExtended();
